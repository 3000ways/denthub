...
export const FOCUS_OPTIONS = [
  { label: 'Growing production',         topics: ['Practice Growth'] },
  { label: 'Hiring or building a team',  topics: ['Team & HR'] },
  { label: 'Technology',                 topics: ['Technology'] },
  { label: 'Marketing',                  topics: ['Marketing'] },
  { label: 'Finance or tax',             topics: ['Finance & Investment'] },
  { label: 'Work-life balance',          topics: ['Wellness'] },
  { label: 'Clinical skills',            topics: ['Clinical'] },
