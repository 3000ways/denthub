...
export function EpisodeCard({ ep, isNew, isFeatured, onSignInRequired }) {
  ...
  return (
    <div
      ...
      {/* Play action only. Show notes now live on the episode page (reached via
          the title link), so the row keeps just Play — a narrower column lets the
          bookmark sit closer and gives the title more room. */}
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'flex-end', flexShrink: 0, width: 52 }}>
