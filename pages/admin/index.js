...
const TABS = ['Add Resource', 'Review Queue', 'All Resources', 'Run Research', 'Auto-Tag', 'Deduplication', 'Users', 'Episode Archive', 'Featured Content', 'Settings', 'Scoring', 'Claims', 'Episode Tagging', 'Quiz Questions'];
  ...
  return (
    <div style={{ minHeight: '100vh', background: '#f5f2eb', fontFamily: FONT }}>
      ...
      <div style={{ maxWidth: 700, margin: '0 auto', padding: '24px 16px 60px' }}>
        ...
        {tab === 10 && <ScoringTab />}
        {tab === 11 && <ClaimsTab />}
        {tab === 12 && <EpisodeTaggingTab />}
        {tab === 13 && <QuizOptionsTab />}
      </div>
    </div>
  );
}
